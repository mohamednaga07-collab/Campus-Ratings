...
export default function DoctorProfile() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className={cn("transition-all duration-300", isReviewDialogOpen ? "blur-md scale-[0.99] opacity-50 pointer-events-none select-none grayscale-[0.2]" : "")}>
        <Header />
                      ...
                      <div className="mt-6 flex flex-wrap items-end justify-between gap-4">
                        ...
                        {user?.role === "student" && (
                          <Dialog open={isReviewDialogOpen} onOpenChange={setIsReviewDialogOpen}>
                            ...
                            <DialogContent className="max-w-lg max-h-[85vh] overflow-y-auto !left-[15%] !top-[10%] !translate-x-0 !translate-y-0 bg-background/80 backdrop-blur-xl shadow-[0_0_50px_0_rgba(0,0,0,0.5)] border-white/10">
                              <DialogHeader>
                                <DialogTitle>
