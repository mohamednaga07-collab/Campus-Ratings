...
export default function Home() {
  ...
  // Hero images carousel - 4K resolution with 8 diverse education images
  const heroImages = [
          ...
          <div className="grid lg:grid-cols-3 gap-4">
            <Card className="bg-card/90 border border-border shadow-sm">
              <CardContent className="p-5 flex flex-col gap-4">
                ...
                <div className="flex items-center justify-between">
                  <p className="text-sm text-muted-foreground">{t("home.enhance.compareDesc", { defaultValue: "Quickly spot strengths before you decide." })}</p>
            ...
            <Card className="bg-card/90 border border-border shadow-sm">
              <CardContent className="p-5 flex flex-col gap-3">
                ...
                <div className="flex items-center justify-between pt-1">
                  <p className="text-sm text-muted-foreground">{t("home.enhance.rateDesc", { defaultValue: "Stay structured while staying fast." })}</p>
                  <Button asChild size="sm" variant="outline" className="gap-2">
