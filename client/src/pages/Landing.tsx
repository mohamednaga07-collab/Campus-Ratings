            ...
            <div className="container mx-auto max-w-4xl text-center px-4">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  <Button size="lg" onClick={scrollToAuth} data-testid="button-get-started">
        ...
        <section className="py-24 bg-background">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                { key: "student", icon: Users, color: "from-blue-600 to-indigo-600", descriptionId: "landing.roles.cards.student" },
                { key: "teacher", icon: GraduationCap, color: "from-purple-600 to-pink-600", descriptionId: "landing.roles.cards.teacher" },
                { key: "admin", icon: Shield, color: "from-slate-700 to-slate-900", descriptionId: "landing.roles.cards.admin" },
              ].map((role, idx) => (
                <motion.div
                  key={role.key}
                ...
                >
                  <Card className={`${styles.roleCard} h-full border-border/40 hover:border-primary/50 transition-all`}>
                    ...
                    <CardContent className="pt-10 pb-8 px-8">
                      ...
                      <Button variant="ghost" onClick={scrollToAuth} className="w-full group hover:bg-primary hover:text-white border border-border/60">
                        {t("landing.getStarted")}
        ...
        <section id="auth-section" className="py-20 px-4 bg-slate-50 dark:bg-slate-950 text-foreground transition-colors duration-300">
          <div className="container mx-auto max-w-6xl grid lg:grid-cols-2 gap-10 items-start">
            <motion.div
              ...
              viewport={{ once: true }}
              className="space-y-6 pt-6 md:pt-12"
            >
        ...
        <section className="py-20 px-4 bg-gradient-to-r from-primary to-primary/80 text-primary-foreground">
          <div className="container mx-auto max-w-4xl text-center">
            ...
            >
              ...
              <Button size="lg" variant="secondary" onClick={scrollToAuth}>
                {t("landing.getStarted")}
                <ChevronRight className="h-5 w-5 ml-1" />
              </Button>
            </motion.div>
