            ...
            <Card className="border border-primary/10 shadow-xl shadow-primary/10 backdrop-blur-sm bg-card/80">
              <CardHeader className="space-y-3">
                <div className="inline-flex items-center gap-2 w-fit rounded-full bg-primary/10 px-3 py-1 text-xs font-medium text-primary">
                  <span>{t("auth.forgotPassword", { defaultValue: "Forgot Password?" })}</span>
                </div>
                <div>
                  ...
                  >
                    ...
                    <div className="text-center">
                      <h3 className="font-semibold text-foreground mb-2">
                        {t("auth.resetLinkSent", { defaultValue: "Reset link sent!" })}
                      </h3>
                      <p className="text-sm text-muted-foreground mb-4">
                        {t("auth.resetLinkSentDesc", {
                          defaultValue: "Check your email for a link to reset your password. The link will expire in 24 hours.",
                        })}
                      </p>
                    </div>
                  </motion.div>
